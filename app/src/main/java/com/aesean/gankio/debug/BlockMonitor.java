...
package com.aesean.gankio.debug;
...
public class BlockMonitor {
    ...
    public static class Builder {
         ...
         * 卡顿，单位毫秒。
         *
         * @param blockDelayMillis 卡顿间隔，单位毫秒。假如这里设置1000，
         *                         表示主线程处理Message消息耗时超过1秒钟后打印卡顿数据。
         */
         ...
         * @return BlockMonitor
         */
        public BlockMonitor builder(Looper looper) {
            return new BlockMonitor(looper, blockDelayMillis, maxPostTimes
                    , dumpStackDelayMillis, startDumpStackDelayMillis, syncDelay
                    , printInDebuggerConnected, printSameStack, printer);
        }
    }

    private BlockMonitor(Looper looper, long blockDelayMillis, int maxPostTimes
    ...
    public void install() {
        ...
        mTargetLooper.setMessageLogging(createBlockPrinter());
        mRunning = true;
    }
    ...
    private static class InstanceHolder {
        private static final BlockMonitor sInstance = new Builder().builder(Looper.getMainLooper());
    }
    ...
    private class PrintStaceInfoRunnable implements Runnable {
        ...
        private String dumpStack() {
            return BlockMonitor.dumpStack(getDumpThread());
        }
        ...
        private void printStackTraceInfo(String info) {
            ...
            if (mPrinter == null) {
                ...
                for (String s : split) {
                    if (!TextUtils.isEmpty(s)) {
                        String msg = s + "\n";
                        boolean print = mPrinter.print(msg);
                        if (!print) {
                            Log.d(TAG, msg);
                        }
                    }
