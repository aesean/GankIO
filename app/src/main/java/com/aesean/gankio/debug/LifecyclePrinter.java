...
public class LifecyclePrinter {
    ...
    public static class Builder {
        private String tag = "LifecyclePrinter";
        ...
        public LifecyclePrinter build() {
            ...
            return new LifecyclePrinter(application, tag);
        }
    }

    private LifecyclePrinter(Application application, String tag) {
        if (application == null) {
    ...
    private FragmentManager.FragmentLifecycleCallbacks registerFragmentLifecycleCallback(Activity activity) {
        if (activity instanceof FragmentActivity) {
            ...
            FragmentManager.FragmentLifecycleCallbacks fragmentLifecycleCallbacks
                ...
                //     Log.d(mTag, "onFragmentViewCreated: " + LifecyclePrinter.toString(f));
                // }
